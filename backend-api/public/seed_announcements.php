...
// Quick script to seed more announcements
// Access via: http://localhost:8000/seed_announcements.php
...
$announcements = [
    ...
    [
        ...
        'description' => 'Spécialiste en domotique et maisons intelligentes recherché pour projets résidentiels haut de gamme. Maîtrise des systèmes KNX et Zigbee exigée.',
        'city' => 'Casablanca',
    ...
    [
        ...
        'description' => "Grand projet hôtelier à Marrakech recrute un chef plombier avec minimum 10 ans d'expérience. Supervision d'une équipe de 8 plombiers.",
        'city' => 'Marrakech',
    ...
    [
        ...
        'description' => 'Recherche plombier chauffagiste pour installation de systèmes de chauffage central dans des villas à Ifrane et Azrou.',
        'city' => 'Ifrane',
    ...
    [
        ...
        'description' => 'Atelier de menuiserie haut de gamme à Essaouira recrute un maître ébéniste spécialisé en thuya et cèdre pour clientèle internationale.',
        'city' => 'Essaouira',
    ...
    [
        ...
        'description' => "Projet de restauration d'un riad historique dans la médina de Fès. Recherche artisan maîtrisant les techniques traditionnelles du tadelakt.",
        'city' => 'Fès',
    ...
    [
        ...
        'description' => 'Recrutement de 5 peintres qualifiés pour un grand projet résidentiel de 120 appartements. Expérience en finitions haut de gamme.',
        'city' => 'Rabat',
    ...
    [
        ...
        'description' => "Maintenance préventive et curative des systèmes CVC d'un centre commercial. Habilitation fluides frigorigènes obligatoire.",
        'city' => 'Casablanca',
    ...
    [
        ...
        'description' => "Entreprise de restauration du patrimoine recrute des maçons spécialisés en pierre taillée pour la réhabilitation d'un palais historique.",
        'city' => 'Meknès',
    ...
    [
        ...
        'description' => 'Projet de tour de bureaux de 15 étages. Recherche poseurs de murs rideaux expérimentés. Prime de risque incluse.',
        'city' => 'Casablanca',
    ...
    [
        ...
        'description' => "Gestion d'un atelier de 6 postes de travail. Planification des interventions et gestion d'une équipe de 8 techniciens.",
        'city' => 'Agadir',
    ...
    [
        ...
        'description' => "Construction d'un hammam traditionnel de luxe. Recherche carreleur mosaïste maîtrisant la pose de zellige et marbre sur surfaces courbes.",
        'city' => 'Marrakech',
    ...
    [
        ...
        'description' => "Aménagement paysager d'un parcours de golf 18 trous. Recherche paysagiste expérimenté en gazon sportif et systèmes d'irrigation.",
        'city' => 'El Jadida',
...
echo json_encode([
    'success' => true,
    'message' => "$count annonces ajoutées avec succès !",
    'errors' => $errors,
    'total_in_db' => Announcement::count(),
]);
